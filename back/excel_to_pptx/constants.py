...
# --- БАЗОВАЯ ТИПОГРАФИКА И ЦВЕТА ---
    ...
    SURVEY_COLORS = [
        RGBColor(94, 185, 185),   # '#5eb9b9' - Светлый бирюзовый
        RGBColor(120, 214, 175),  # '#78d6af' - Мягкий мятно-зеленый
        RGBColor(194, 226, 175),  # '#c2e2af' - Светлый пастельно-зеленый
        RGBColor(253, 246, 211),  # '#fdf6d3' - Нежный кремово-желтый
        RGBColor(245, 215, 166),  # '#f5d7a6' - Теплая светлая охра
        RGBColor(242, 149, 116)   # '#f29574' - Светлый коралловый
    ]